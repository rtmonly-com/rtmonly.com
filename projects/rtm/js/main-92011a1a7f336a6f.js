    ...
    5274: function(e, t, r) {
        ...
        class Y extends y.default.Component {
            ...
            componentDidMount() {
                ...
                j.isDynamicRoute)(n.pathname) || location.search || $) || a.props && a.props.__N_SSG && (location.search || $)) && n.replace(n.pathname + "?" + String((0,
                S.assign)((0,
        ...
        function ee(e) {
            ...
            i.loadPage("/_error").then(n=>{
                ...
                O.loadGetInitialProps)(t, f)).then(t=>eu({
                    ...e,
                    err: l,
                    Component: u,
                    styleSheets: s,
        ...
        async function ec(e) {
            ...
            n = (0,
            L.createRouter)(a.page, a.query, o, {
    ...
    5932: function(e, t, r) {
        ...
        class V {
            ...
            async change(e, t, r, n, a) {
                ...
                this._inFlightRoute && this.clc && (X || V.events.emit("routeChangeError", T(), this._inFlightRoute, J),
                this.clc(),
                this.clc = null),
                r = (0,
                w.addBasePath)((0,
                ...
                try {
                    ...
                    let v = F && !y && !G && !Z && (0,
                    R.compareRouterStates)(_, this.state);
                    if (!v) {
                        try {
                            await this.set(_, o, y)
                        } catch (e) {
            ...
            async getRouteInfo(e) {
                ...
                try {
                    ...
                    return R.__N_SSP && E.dataHref && A && delete this.sdc[A],
                    this.isPreview || !R.__N_SSG || p || W(Object.assign({}, E, {
                        isBackground: !0,
                        persistCache: !1,
    ...
    8018: function(e) {
        ...
        x = function(e) {
            if (e.cancelable) {
                ...
                addEventListener("pointercancel", r, S)) : O(a, e)
            }
        }
        ,
        C = function(e) {
